    ...
    render() {
        ...
        return (<div className={"w-full p-36 mr-2"}>
                ...
                <div className='grid grid-cols-3 gap-4 flex items-center justify-center'>
                    <div>
                        <svg className={`cursor-pointer flex-none  duration-500 `} width="160"
                             height="66" viewBox="0 0 181 66" fill="green" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div className={"justify-center"}>
                        <p className='font-bold text-xl font-sans my-3 w-full text-center'>INFORME DE RECEPCIÓN DE
                            MATERIA
                            PRIMA</p>
                    </div>
                </div>
                {/*Title*/}
                <div className={"mt-4 w-full bg-[#26d07d]"}>
                    <h3 className={"text-xs mt-4 font-semibold p-2 text-center text-white"}>INFORME
                        N° {info?.category_name.toUpperCase()}/{info?.lot.substring(info?.lot.length - 3)} - GREENBOX
                        S.A.C.</h3>
                </div>
                <div className={"mt-2 w-full flex flex-col"}>
                    <div className={"flex flex-row gap-24"}>
                        <h3 className={"text-md mt-4  p-2 text-center"}>A:</h3>
                        <div className={"flex flex-col"}>
                            <h3 className={"text-md mt-4  p-2 text-center"}>{info?.provider_name}</h3>
                            <h3 className={"text-md font-semibold ml-4  text-center"}>Proveedor de materia prima</h3>
                        </div>
                    </div>
                    <div className={"flex flex-row gap-24"}>
                    ...
                    <div className={"flex flex-row gap-14"}>
                        <h3 className={"text-md   p-2 text-center"}>ASUNTO:</h3>
                        <div className={"flex flex-col"}>
                            <h3 className={"text-md p-2 text-center"}>Informe de recepción de materia
                                prima {info?.category_name}</h3>
                        </div>
                    </div>
                    <div className={"flex flex-row gap-20 border-b-4 border-solid border-"}>
                        <h3 className={"text-md   p-2 text-center"}>Fecha:</h3>
                        <h3 className={"text-md   p-2 text-center"}>{new Date(info?.downloadDate).toLocaleDateString('es-PE', {
                ...
                <div className={'mt-4 '}>
                    <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Estimado(a). {info?.provider_name}; por medio del presente reciban un cordial saludo a nombre
                        del
                        departamento de Logística -
                        Greenbox S.A.C. y a la vez informarles los detalles de la carga recibida.
                    </h1>
                    <h1>Se recibieron en total <span
                        className={"font-bold"}> {info?.quantity_boxes} JABAS DE PLÁSTICO</span> con contenido
                        de {info?.category_name.toUpperCase()} {info?.variety} {info?.condition}.</h1>
                </div>
                <div className={'mt-4'}>
                    <h1 className={"text-red-600"}>{info?.description}</h1>
                </div>
                <div className={'mt-4 '}>
                    <h1>El área de Control de Calidad tomó {info?.quality} Kg para colocar sus muestras y análisis.</h1>
                </div>
                ...
                <div className="mt-4 p-5 ">
                    ...
                    <div>
                        <h1 className={"font-bold"}>1. DATOS GENERALES</h1>
                        <table className="bg-white ">
                            ...
                            <tr>
                                ...
                                <td className="font-bold uppercase text-center border border-black px-8 py-1">{info?.provider_name}</td>
                            </tr>
                            <tr>
                                <td className="font-bold border border-black px-2 py-1">PROCEDENCIA:</td>
                                <td className="font-bold uppercase text-center border border-black px-8 py-1">{info?.origin}</td>
                            </tr>
                            <tr>
                                <td className="font-bold border border-black px-2 py-1">GUIA DE REMISIÓN:</td>
                                <td className="font-bold uppercase text-center border border-black px-8 py-1">{info?.providerGuide}</td>
                            </tr>
                            <tr>
                                <td className="font-bold border border-black px-2 py-1">PARCELA:</td>
                                <td className="font-bold uppercase text-center border border-black px-8 py-1">{info?.parcel}</td>
                            </tr>
                            <tr>
                                <td className="font-bold border border-black px-2 py-1">LOTE GB:</td>
                                <td className="font-bold uppercase text-center border border-black px-8 py-1">{info?.lot}</td>
                            </tr>
                            </tbody>
                    ...
                    <div>
                        <h1 className={"font-bold mt-2"}>2. RECEPCIÓN</h1>
                        <table className="bg-white w-full">
                            <tbody>
                            <tr className={"w-full"}>
                                <td className="font-bold text-center border border-2 border-black bg-[#26d07d] px-8 py-1">TOTAL
                                    PESO NETO
                                </td>
                                <td className="font-bold uppercase text-center bg-[#26d07d] border border-2 border-black px-8 py-1">{Humanize.formatNumber(info?.net_weight, 2)}</td>
                                <td className="font-bold uppercase text-center bg-[#26d07d] border border-2 border-black px-8 py-1">Kg.</td>
                            </tr>
                            <tr className={"w-full"}>
                                <td className="font-bold text-center border border-2 border-black bg-[#26d07d] px-8 py-1">TOTAL
                                    PESO BRUTO
                                </td>
                                <td className="font-bold uppercase text-center bg-[#26d07d] border border-2 border-black px-8 py-1">{Humanize.formatNumber(info?.brute_weight, 2)}</td>
                                <td className="font-bold uppercase text-center bg-[#26d07d] border border-2 border-black px-8 py-1">Kg.</td>
                            </tr>
                            <tr className={"w-full"}>
                                <td className="font-bold text-center border border-2 border-black bg-[#26d07d] px-8 py-1">TOTAL
                                ...
                                <td className="font-bold uppercase text-center bg-[#26d07d] border border-2 border-black px-8 py-1">{Humanize.formatNumber(info?.amount_guide_kg, 2)}</td>
                                <td className="font-bold uppercase text-center bg-[#26d07d] border border-2 border-black px-8 py-1">Kg.</td>
                            </tr>
                            </tbody>
                    ...
                    <div className={"grid grid-cols-2 mt-4 gap-6 items-center"}>
                        <div>
                            <table className="bg-white w-full">
                                <tbody>
                                <tr className={"w-full flex justify-between bg-[#26d07d] border border-black border-2"}>
                                    <td className="font-bold px-2">TOTAL
                                        DE JABAS
                                    </td>
                                    <td className="font-bold uppercase text-center px-2">{info?.quantity_boxes}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE J. GB
                                    </td>
                                    <td className="font-semibold uppercase text-center px-2">{info.boxes.gb}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE J. PAE</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.boxes.pa}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE J. TIBANA</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.boxes.t0}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE J. TIBANA I</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.boxes.t1}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE J. TIBANA II</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.boxes.t2}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE J. GANDULES</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.boxes.gn}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE J. COLORES</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.boxes.co}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE J. MADERA</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.boxes.ma}</td>
                                </tr>
                                <tr className={"w-full flex justify-between bg-[#26d07d] border border-black border-2"}>
                                    <td className="font-bold px-2">TOTAL PESO NETO
                                    </td>
                                    <td className="font-bold uppercase text-center px-2">{Humanize.formatNumber(info?.net_weight, 2)}</td>
                                </tr>
                                </tbody>
                            </table>
                            <table className="bg-white w-full mt-4">
                                <tbody>
                                <tr className={"w-full  bg-[#26d07d] border border-black border-2"}>
                                    <td className="font-bold text-center px-2">OBSERVACIÓN</td>
                                    <td className="font-bold text-center uppercase text-center px-2">KG.</td>
                                </tr>
                                <tr className={"w-full  border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold  text-center   px-2">TOTAL PESO NETO
                                    </td>
                                    <td className="font-semibold text-center uppercase text-center px-2">{Humanize.formatNumber(info?.net_weight, 2)}</td>
                                </tr>
                                <tr className={"w-full  border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold  text-center   px-2">KG DESCONTADOS
                                        ({Humanize.formatNumber(info?.discount_percentage, 2)}%)
                                    </td>
                                    <td className="font-semibold text-center uppercase text-center px-2">{Humanize.formatNumber(info?.discount_net_kg, 2)}</td>
                                </tr>
                                <tr className={"w-full  bg-yellow-400 border border-black border-2"}>
                                    <td className="font-bold text-center px-2">TOTAL PESO NETO
                                        A PAGAR
                                    </td>
                                    <td className="font-bold text-center uppercase text-center px-2">{Humanize.formatNumber(info?.amount_net_kg, 2)}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <div className={""}>
                            <table className=" bg-white w-full">
                                <tbody>
                                <tr className={"w-full flex justify-between bg-[#26d07d] border border-black border-2"}>
                                    <td className="font-bold px-2">ITEM</td>
                                    <td className="font-bold  text-center px-2">Cant.</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE PAR. AZUL</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.pallets.Azul}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE PAR. VERDES</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.pallets.Verde}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE PAR. NEGRAS</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.pallets.Negro}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE PAR. CELESTE</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.pallets.Celeste}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE PAR. ROJAS</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.pallets.Rojo}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE PAR. MADERA</td>
                                    <td className="font-semibold uppercase text-center px-2">{info?.pallets.Madera}</td>
                                </tr>


                                <tr className={"w-full flex justify-between bg-[#26d07d] border border-black border-2"}>
                                    <td className="font-bold px-2">TOTAL DE PARIHUELAS
                                    </td>
                                    <td className="font-bold uppercase text-center px-2">{info?.pallets.Negro + info?.pallets.Azul + info?.pallets.Celeste + info?.pallets.Rojo + info?.pallets.Verde + info?.pallets.Madera}</td>
                                </tr>
                                </tbody>
                            </table>
                            <table className=" bg-white w-full mt-4">
                                <tbody>
                                <tr className={"w-full flex justify-between bg-[#26d07d] border border-black border-2"}>
                                    <td className="font-bold px-2 text-center">ITEM</td>
                                    <td className="font-bold  text-center px-2">Kg.</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE JABAS</td>
                                    <td className="font-semibold uppercase text-center px-2">{Humanize.formatNumber(info?.weight_boxes, 2)}</td>
                                </tr>
                                <tr className={"w-full flex justify-between border-l-2 border-r-2 border-black"}>
                                    <td className="font-semibold    px-2">TOTAL DE PARIHUELAS</td>
                                    <td className="font-semibold uppercase text-center px-2">{Humanize.formatNumber(info?.weight_pallets, 2)}</td>
                                </tr>

                                <tr className={"w-full flex justify-between bg-[#26d07d] border border-black border-2"}>
                                    <td className="font-bold px-2">TOTAL
                                    </td>
                                    <td className="font-bold uppercase text-center px-2">{Humanize.formatNumber(info?.total_tare, 2)}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
                    {info?.category_name === "Piña" && <div className={""}>
                        <h1 className={"font-bold mt-2"}>3. ESTADO DE CALIBRES</h1>
                        <table className=" bg-white w-full">
                            <tbody>
                            <tr className={"w-full  bg-[#26d07d] border border-black border-2"}>
                                <td className="font-bold px-2">CALIBRES</td>
                                <td className="font-bold uppercase text-center px-2">#JABAS</td>
                                <td className="font-bold uppercase text-center px-2">PESO</td>
                                <td className="font-bold uppercase text-center px-2">%</td>
                            </tr>
                            <tr className={"w-full  border-l-2 border-r-2 border-black"}>
                                <td className="font-semibold px-2">Calib. 6</td>
                                <td className="font-semibold uppercase text-center px-2">{info?.calibers.c6}</td>
                                <td className="font-semibold  text-center px-2">{Humanize.formatNumber(info?.net_weight * (info?.calibers.c6 / info?.quantity_boxes), 2)} kg.</td>
                                <td className="font-semibold uppercase text-center px-2">{Humanize.formatNumber((info?.calibers.c6 / info?.quantity_boxes) * 100, 2)}</td>
                            </tr>
                            <tr className={"w-full  border-l-2 border-r-2 border-black"}>
                                <td className="font-semibold px-2">Calib. 8</td>
                                <td className="font-semibold uppercase text-center px-2">{info?.calibers.c8}</td>
                                <td className="font-semibold  text-center px-2">{Humanize.formatNumber(info?.net_weight * (info?.calibers.c8 / info?.quantity_boxes), 2)} kg.</td>
                                <td className="font-semibold uppercase text-center px-2">{Humanize.formatNumber((info?.calibers.c8 / info?.quantity_boxes) * 100, 2)}</td>
                            </tr>
                            <tr className={"w-full  border-l-2 border-r-2 border-black"}>
                                <td className="font-semibold px-2">Calib. 10</td>
                                <td className="font-semibold uppercase text-center px-2">{info?.calibers.c10}</td>
                                <td className="font-semibold  text-center px-2">{Humanize.formatNumber(info?.net_weight * (info?.calibers.c10 / info?.quantity_boxes), 2)} kg.</td>
                                <td className="font-semibold uppercase text-center px-2">{Humanize.formatNumber((info?.calibers.c10 / info?.quantity_boxes) * 100, 2)}</td>
                            </tr>
                            <tr className={"w-full  border-l-2 border-r-2 border-black"}>
                                <td className="font-semibold px-2">Calib. 12</td>
                                <td className="font-semibold uppercase text-center px-2">{info?.calibers.c12}</td>
                                <td className="font-semibold  text-center px-2">{Humanize.formatNumber(info?.net_weight * (info?.calibers.c12 / info?.quantity_boxes), 2)} kg.</td>
                                <td className="font-semibold uppercase text-center px-2">{Humanize.formatNumber((info?.calibers.c12 / info?.quantity_boxes) * 100, 2)}</td>
                            </tr>
                            <tr className={"w-full  border-l-2 border-r-2 border-black"}>
                                <td className="font-semibold px-2">Calib. 14</td>
                                <td className="font-semibold uppercase text-center px-2">{info?.calibers.c14}</td>
                                <td className="font-semibold  text-center px-2">{Humanize.formatNumber(info?.net_weight * (info?.calibers.c14 / info?.quantity_boxes), 2)} kg.</td>
                                <td className="font-semibold uppercase text-center px-2">{Humanize.formatNumber((info?.calibers.c14 / info?.quantity_boxes) * 100, 2)}</td>
                            </tr>
                            <tr className={"w-full  bg-[#26d07d] border border-black border-2"}>
                                <td className="font-bold px-2">TOTAL
                                </td>
                                <td className="font-bold uppercase text-center px-2">{info?.quantity_boxes}</td>
                                <td className="font-bold uppercase text-center px-2">{Humanize.formatNumber(info?.net_weight, 2)}</td>
                                <td className="font-bold uppercase text-center px-2">100.00%</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>}
                    ...
                    <div className={"flex flex-row  w-full gap-48  justify-center mt-48"}>
                        <div className={"flex flex-col justify-center items-center"}>
                            <img src={require(`../../assets/carellano.jpeg`)} alt={'carellano'}
                                 className="h-24 w-24 group-hover:text-gray-50"/>
                            <h1 className={"font-semibold"}>Revisado por:</h1>
                            <h1 className={"font-semibold"}>Christian Arellano Rojas</h1>
                            <h1 className={"font-semibold"}>Jefe de Logistica</h1>
                            <h1 className={"font-semibold"}>careallano@greenbox.pe</h1>
                        </div>
                        <div className={"flex flex-col justify-center items-center"}>
                            <img src={require(`../../assets/jzaldivar.jpeg`)} alt={"jzaldivar"}
                                 className="h-24 w-24 group-hover:text-gray-50"/>
                            <h1 className={"font-semibold"}>Juan Zaldivar</h1>
                            <h1 className={"font-semibold"}>Gerente de Administración y Finanzas</h1>
                            <h1 className={"font-semibold"}>jzaldivar@greenbox.pe</h1>
                        </div>
                    </div>
                </div>
