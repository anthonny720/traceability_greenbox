...
const FormAnalysisMango = ({close, data, dispatch}) => {
    ...
    const columns = [{name: 'color_1_5', title: 'Color <1-5 %', type: 'text', maxLength: 4,}, {
        name: 'color_1_5_2',
        title: 'Color 1,5 -  2 %',
        type: 'text',
        maxLength: 4,
        ...
        name: 'weight_280_300',
        title: 'Peso 280-300 gr %',
        type: 'text',
        maxLength: 4,
    }, {name: 'weight_300', title: 'Peso >300 gr %', type: 'text', maxLength: 4,}, {
        name: 'cracked_mechanical_damage',
        title: 'Rajados y daños mecanicos %',
        type: 'text',
        maxLength: 4,
...
const initialValues = (data) => {
    return {
        ...
        color_1_5_2: data?.color_1_5_2 || 0,
        ...
        cracked_mechanical_damage: data?.cracked_mechanical_damage || 0,
...
const newSchema = () => {
    return {
        ...
        color_1_5_2: Yup.number().min(0).max(100).required(),
        ...
        cracked_mechanical_damage: Yup.number().min(0).max(100).required(),
