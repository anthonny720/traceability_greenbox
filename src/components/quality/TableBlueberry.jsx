...
const Table = ({data, update}) => {
    const columns = ['Acciones', 'Lote MP', 'Peso neto', 'Jabas', 'Brix promedio %', 'Brix máximo %', 'Brix mínimo %', 'Calibre 1 <=11 %', 'Calibre 2 12 -18 %', 'Calibre 3 >=19 %', 'Verde %', 'Aplastado %', 'Daños mecánicos %', 'Sin daños %']
