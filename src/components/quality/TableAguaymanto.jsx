...
const Table = ({data, update}) => {
    const columns = ['Acciones', 'Lote MP', 'Peso neto', 'Jabas', 'Maduración 1 %', 'Maduración 2 %', 'Maduración 3 %', 'Maduración Total %', 'Hongos y fermentado %', 'Verde %', 'Rajado %', 'Aplastado %', 'Fitosanitario %', 'Consistencia Aguada %', 'Defectos %']
