...
const social = [{
    name: 'GitHub', href: 'https://github.com/anthonny720', icon: (props) => (<FontAwesomeIcon icon={faG}/>),
},]
...
export default function Navbar() {
    ...
    return (<>
        ...
        <Helmet>
            ...
            <meta name="description" content="Sistema - Greenbox"/>
        </Helmet>
            ...
            {({open}) => (<>
                    ...
                    <div className="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
                        <div className="flex md:absolute md:left-0 md:inset-y-0 lg:static xl:col-span-2">
                            <div className="flex-shrink-0 flex items-center">
                                <NavLink to="/">
                                    <svg className="cursor-pointer flex  duration-500 rotate-[360deg]"
                                         width="75" height="55" viewBox="0 0 181 66" fill="none"
                                ...
                                <NavLink to="/"
                                         style={({isActive}) => (isActive ? {
                                             color: '#26d07d', fontWeight: 'bold'
                                         } : {color: 'text-gray-500'})}
                                         className={"mx-1 hidden  sm:hidden md:flex sm:mx-4 text-lg dark:hover:text-white hover:text-[#26d07d] text-gray-600 dark:text-dark-txt text-md font-gilroy-semibold"}>
                                    Dashboard
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4 gap-2 ">
                            {map(list, (item, key) => (<div key={key} className=" top-16 w-56 text-right">
                                <Dropdown title={key} list={item}/>
                            </div>))}
                        </div>
                    </div>
                </div>
                ...
                <Popover.Panel as="nav" className="lg:hidden z-[117]" aria-label="Global">
                    <div className="max-w-3xl mx-auto px-2 z-[117] pt-2 pb-3 space-y-1 sm:px-4 bg-white">
                        <PopoverMe onClick={logoutHandler}/>
                        {map(list, (item, key) => (<div key={key} className="w-full ">
                            <Dropdown title={key} list={item}/>
                        </div>))}
