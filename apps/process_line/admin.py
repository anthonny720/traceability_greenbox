...
class TypeCut(ImportExportModelAdmin, admin.ModelAdmin):
    list_display = ('name', 'code',)


@admin.register(ProcessLineConditioning)
class ProcessLineConditioningAdmin(ImportExportModelAdmin, admin.ModelAdmin):
...
class ProcessLineTerminatedAdmin(ImportExportModelAdmin, admin.ModelAdmin):
...
class ProcessLineReleasedAdmin(ImportExportModelAdmin, admin.ModelAdmin):
