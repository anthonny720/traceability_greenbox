...
class Payments(models.Model):
    ...
    report = models.OneToOneField(Lot, on_delete=models.CASCADE, related_name='entry_report', verbose_name='Reporte')
...
class Kardex(models.Model):
    ...
    category = models.ForeignKey(Fruits, on_delete=models.CASCADE, verbose_name='Fruta', related_name='kardex_category')
...
class Motion(models.Model):
    ...
    to = models.ForeignKey(ProviderMP, on_delete=models.CASCADE, related_name='to', verbose_name="Origen")
